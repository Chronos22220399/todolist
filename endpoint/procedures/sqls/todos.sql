CREATE TABLE IF NOT EXISTS todos (
  ...
  is_completed TINTINT(1) DEFAULT 0,
  ...
  FOREIGN KEY (category_id) REFERENCES task_categories(category_id) -- Foreign key constraint linking category_id to task_categories table
);
