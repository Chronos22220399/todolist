CREATE TABLE IF NOT EXISTS todo (
  ...
  FOREIGN KEY (created_by) REFERENCES user(user_id), -- Foreign key constraint linking created_by to users table
  FOREIGN KEY (category_id) REFERENCES task_category(category_id) -- Foreign key constraint linking created_by to users table
);
